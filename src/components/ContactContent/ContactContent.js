            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="row">
                        ...
                        <br></br>
                        <div className="col">
                            <a target="_blank" href="https://www.linkedin.com/in/jshsandberg/" ><img style={faviconStyle} alt={Linkedin} src={Linkedin}></img>
                            <br></br>
                            <p style={textStyle}>https://www.linkedin.com/in/jshsandberg/</p>
                            </a>
                        </div>
                        <br></br>
                        <br></br>
                        <div className="col">
                            <a target="_blank" href="https://github.com/jshsandberg"><img style={faviconStyle} alt={Github} src={Github}></img>
                            <br></br>
                            <p style={textStyle}>https://github.com/jshsandberg</p>
                            </a>
                        </div>
                        <br></br>
                        <br></br>
                        <div className="col">
                            <a target="_blank" href="mailto: jshsandberg@gmail.com"><img style={faviconStyle} alt={Gmail} src={Gmail}></img>
                            <br></br>
                            <p style={textStyle}>jshsandberg@gmail.com</p>
                            </a>
                        </div>
                    </div>
